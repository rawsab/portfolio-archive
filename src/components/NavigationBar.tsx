...
export default function NavigationBar() {
  return (
    <nav className="sticky top-0 z-50 bg-[#EFF1F7]/90 backdrop-blur-[4px] pt-2">
      <div className="font-acuminpro tracking-[-0.025em] w-[60vw] max-w-[947px] min-w-[852px] mx-auto px-2 pb-2 pt-2 flex justify-between items-center border-b border-[#e0e0e0]">
