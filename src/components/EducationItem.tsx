  ...
  return (
    <div className="flex flex-col md:flex-row items-start md:items-center w-full gap-4 md:gap-x-2 mb-5">
      <div className="flex items-center gap-x-2 w-full md:w-auto">
        ...
        <div className="flex flex-col justify-center flex-shrink-0 text-right ml-auto md:hidden hide-456">
      ...
      <div className="flex-1 w-full md:w-auto">
        <div className="min-h-[60px] px-4 py-2 flex items-center rounded-[12px] border border-[var(--foreground)]/20 text-sm text-[var(--foreground)] max-w-[680px]">
          <div>
            <p className="text-[var(--foreground)]/70 whitespace-pre-wrap">
              {focus}
            </p>
          </div>
        </div>
      ...
      <div className="hidden md:flex flex-col justify-center flex-shrink-0 text-right ml-[10px] min-w-[100px] hide-456">
        <span className="text-[var(--foreground)] font-regular">
          {location}
        </span>
        <span className="text-sm text-[var(--foreground)]/70 mt-[0px]">
